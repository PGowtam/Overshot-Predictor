"""
Volume Fallback: Model Training
================================
Trains the dual-head CNN+LSTM model on fallback tensors.

Uses the same model architecture (src/model.py), training hyperparameters,
and callbacks as train.py.

Reads from:  outputs/fallback/tensors/
Saves to:    outputs/fallback/model.keras
             outputs/fallback/training_log.csv
"""
...
LOG_PATH = FALLBACK_DIR / "training_log.csv"
...
def load_tensors():
    """Load train/val tensors from fallback directory."""
    print("📂 Loading fallback tensors...")
...
def main():
    print("=" * 60)
    print(" Volume Fallback: Model Training")
    print("=" * 60)
